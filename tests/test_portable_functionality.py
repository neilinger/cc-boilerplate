...
class TestSafetyLogicIntegrationScenarios(SafetyLogicTestCase):
    ...
    def test_env_file_access_patterns(self):
        ...
        blocking_cases = [
            ...
            # Note: head/tail .env are NOT in the actual patterns, so they won't be blocked
        ]
        ...
        allowing_cases = [
            ...
            ('Bash', {'command': 'head .env'}),  # Not in the patterns, so allowed
            ('Bash', {'command': 'tail .env'}),  # Not in the patterns, so allowed  
