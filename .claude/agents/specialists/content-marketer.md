...
description: |
  ALWAYS use when: Content strategy, marketing content, blog posts, social media content, email campaigns
  NEVER use when: Technical implementation, code development, non-marketing tasks
