---
description: 'ALWAYS use when: unity developer tasks, domain-specific work
...
tools: Read, Write, Edit, MultiEdit, Bash(unity:*), Task, mcp__Ref__*, mcp__sequential_thinking__*,
  mcp__serena__*
---
